...
class MeasuresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create measure" do
    assert_difference('Measure.count') do
      post measures_url, params: { measure: { axis_id: @measure.axis_id, code: @measure.code, description: @measure.description } }
    end
  ...
  test "should update measure" do
    patch measure_url(@measure), params: { measure: { axis_id: @measure.axis_id, code: @measure.code, description: @measure.description } }
